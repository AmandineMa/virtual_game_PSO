  ...
  subTask.gridInfos = {
    ...
    checkEndCondition: function(context, lastTurn) {
      if (lastTurn) {
            ...
            if (hasNumber) {
              ...
              if (oldNumber != 100) {
                if (itemType.num != oldNumber) {
                  ...
                  throw "You should only modify the boxes containing a zero.";
                }
        ...
        throw "Well done, you've entered the correct numbers!";
      }
    }
  };
    ...
    easy: [
      {
        ...
        initItems: [{ row: 1, col: 0, dir: 0, type: "green_robot" }]
      }
    ],
    medium: [
      {
