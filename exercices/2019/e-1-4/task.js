function initTask(subTask) {
   ...
   subTask.gridInfos = {
      ...
      itemTypes: {
		...
		diamant:	{ num: 5, img: "../images/objects/fond_vert/diamant_orange.png", side: cellSide, category: "paint", isObstacle: false, hasColor: false, color: "diamant", team: 0, zOrder: 0}, 	
		
		caiseJaune:	{ num: 6, img: "../images/objects/fond_vert/caisse_jaune.png", side: cellSide, category: "paint", isObstacle: true, hasColor: false, team: 0, zOrder: 0}, 	
		
		
		 mauve: 	{ num: 7, img: "../images/fonds/mauve.png", side: cellSide, category: "paint", isObstacle: true, hasColor: false, team: 0, zOrder: 0}, 
		 mauveTop: 	{ num: 8, img: "../images/fonds/mauve_top.png", side: cellSide, category: "paint", isObstacle: true, hasColor: false, team: 0, zOrder: 0}, 
		 
		 
		 vertObstacle: 	{ num: 9, img: "../images/fonds/vert.png", side: cellSide, category: "paint", isObstacle: true, hasColor: false, team: 0, zOrder: 0}, 
