   ...
   subTask.gridInfos = {
      ...
      includeBlocks: {
         ...
         standardBlocks: {
            includeAll: false,
            wholeCategories: [],
            singleBlocks: ["controls_repeat_ext", "controls_if", "logic_compare", "math_number", "math_arithmetic"]
         },
               ...
               for (var iCol = 0; iCol < row.length; iCol++) {
                  ...
                  if (hasNumber) {
                     ...
                     if (oldNumber != 100) {
                        ...
                        if ((subTask.iTestCase + 1) != itemType.value) {
                           context.success = false;
