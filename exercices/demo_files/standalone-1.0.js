...
var getStarSVGfull = function() {
  return '<svg height="17.099999999999998" version="1.1" width="18" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative;"><desc style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">Created with Raphaël 2.1.2</desc><defs style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></defs><path fill="#ffc90e" stroke="#000000" d="M46.761,-0.11711L62.135000000000005,26.19589L91.911,32.68589L71.637,55.43889L74.666,85.76389L46.760999999999996,73.51289L18.856999999999996,85.76389L21.884999999999994,55.43889L1.6109999999999935,32.68589L31.386999999999993,26.19589Z" stroke-width="5" transform="matrix(0.18,0,0,0.18,0,0)" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path></svg>';
};

var getStarSVGempty = function() {
  return '<span id="tabScore_medium0_empty" class="emptyStar"><svg height="17.099999999999998" version="1.1" width="18" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative; left: -0.984375px; top: -0.59375px;"><desc style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">Created with Raphaël 2.1.2</desc><defs style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></defs><path fill="#ffffff" stroke="#000000" d="M46.761,-0.11711L62.135000000000005,26.19589L91.911,32.68589L71.637,55.43889L74.666,85.76389L46.760999999999996,73.51289L18.856999999999996,85.76389L21.884999999999994,55.43889L1.6109999999999935,32.68589L31.386999999999993,26.19589Z" stroke-width="5" transform="matrix(0.18,0,0,0.18,0,0)" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path></svg></span>';
};
...
var standaloneLoadPage = function(codes) {
    ...
    */
    ...
    <div id="main_wrapper"> \
     <div id="main"> \
        ...
        <div class="layout_table_wrapper layout_tasks"> \
  ...
  $(document).ready(function() {
    ...
    $("#header_logo").html('<img id="header_logo_img" src="balouk.png" />');
    ...
    for (var iCode = 0; iCode < codes.length; iCode++) {
      ...
      if (!onlyOneGroup) {
        $("#task_icons").append(
          '<div class="groupTitle">' + contents.title + "</div>"
        );
      }
      ...
      for (var iTask = 0; iTask < tasks.length; iTask++) {
        ...
        // image and main link
        var targetNormal =
          pathPrefix + getLinkTask(task.code, options, language);
        if (options == null) {
          options = [];
        }
        ...
        var iconImg =
          '<div class="icon_img"><table><tr><td class="icon_img_td" style="vertical-align: middle;"><img src="' +
          pathPrefix +
          task.code +
          '/icon.png"  ' +
          onclick +
        ...
        if (showDev) {
          ...
          for (
            var iDifficulty = 0;
            iDifficulty < difficulties.length;
            iDifficulty++
          ) {
            var diff = difficulties[iDifficulty];
            if (diff == "easy") diff = "1";
            if (diff == "medium") diff = "2";
            if (diff == "hard") diff = "3";
          ...
          sDev +=
            " <a href='" +
            versionTargets[0].normal +
            "' style='color:black'>[T1]</a>";
          sDev +=
            " <a href='" +
            versionTargets[1].normal +
            "' style='color:black'>[T2]</a>";
          sDev +=
            " <a href='" +
            versionTargets[2].normal +
            "' style='color:black'>[T3]</a>";
          sDev += "&nbsp;&nbsp;&nbsp;";
          sDev +=
            " <a href='" +
            versionTargets[0].solution +
            "' style='color:black'>[S1]</a>";
          sDev +=
            " <a href='" +
            versionTargets[1].solution +
            "' style='color:black'>[S2]</a>";
          sDev +=
            " <a href='" +
            versionTargets[2].solution +
            "' style='color:black'>[S3]</a>";
          //sDev += "&nbsp;&nbsp;";
