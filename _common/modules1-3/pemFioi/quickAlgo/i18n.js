...
var localLanguageStrings = {
  fr: {
    ...
    tooManyIterations: "Your program is taking too long to finish!",
    tooManyIterationsWithoutAction:
      "Your program has run too long without taking action!",
    submitProgram: "Validate the program",
    ...
    fastSpeed: ">>>",
    ludicrousSpeed: "> |",
    stopProgramDesc: "Starting from the beginning",
    stepProgramDesc: "Step by step execution",
    slowSpeedDesc: "Run on this test",
    mediumSpeedDesc: "Average speed",
    fastSpeedDesc: "Fast speed",
    ludicrousSpeedDesc: "Very fast speed",
    ...
    copy: "Copy",
    paste: "Paste",
    limitBlocks: "{remainingBlocks} blocks remaining on {maxBlocks} allowed.",
    limitBlocksOver:
    ...
    nextTestcase: "Next",
    allTests: "All tests:",
    errorEmptyProgram: "The program is empty! Connect blocks.",
    tooManyBlocks: "You are using too many blocks!",
    limitedBlock: "You too often use a limited-use block:",
