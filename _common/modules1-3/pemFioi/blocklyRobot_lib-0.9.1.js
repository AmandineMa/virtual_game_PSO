  ...
  var localLanguageStrings = {
    fr: {
      label: {
        ...
        markedCell: "on a marked box",
        addPlatformAbove: "build a platform above",
        addPlatformInFront: "build a platform in front of",
        platformInFront: "platform in front",
        platformInFrontAndBelow: "platform before lower",
      ...
      messages: {
        ...
        notTransporting:
          "Le robot essaie de déposer un objet mais n'en transporte pas.",
        ...
        successAllMarblesInHoles:
          "Bravo, vous avez rangé toutes les billes&nbsp;!",
        failureOneMarbleInHole: "La bille est mal rangée !",
        failureAllMarblesInHoles:
      ...
      description: {
        ...
        onTriangleObject:
          "surTriangle() : le robot est-il sur un objet triangle ?",
        onDottedObject:
          "surObjetPoints() : le robot est-il sur un objet rempli de points ?",
        ...
        writeNumber:
          "ecrireNombre(nombre) : inscrit le nombre sur la case du robot"
      },
      ...
      downNoPlatform:
        "Le robot essaie de descendre mais il n'y a pas de plateforme en dessous !",
    ...
    de: {
      ...
      messages: {
        ...
        notTransporting:
          "Der Roboter versucht etwas abzulegen, transportiert aber gar nichts.",
        successDroppedAllObjects: "Bravo! Du hast alle Sachen abgelegt.",
        successMarkersPainted:
          "Bravo! Du hast das Muster richtig nachgezeichnet.",
        failureMarkersPainted:
          "Der Roboter hat das Muster nicht genau so gemalt, wie vorgegeben!",
        successPickedAllCollectibles:
          "Bravo! Der Roboter hat alles eingesammelt.",
        failurePickedAllCollectibles:
        ...
        successOneMarbleInHole:
          "Bravo! Der Roboter hat die Murmel richtig abgelegt.",
        successAllMarblesInHoles:
          "Bravo! Der Roboter hat die Murmeln richtig abgelegt.",
        failureOneMarbleInHole:
          "Der Roboter hat die Murmel nicht richtig abgelegt.",
        failureAllMarblesInHoles:
          "Der Roboter hat die Murmeln nicht richtig abgelegt.",
      ...
      jumpObstacleBlocking:
        "Der Roboter hat versucht zu springen, aber ein Hindernis hat ihn blockiert.",
      jumpNoPlatform:
        "Der Roboter hat versucht zu springen, aber über ihm ist keine Plattform.",
      downOutsideGrid:
        "Der Roboter hat versucht, nach unten aus dem Gitter zu springen!",
      downNoPlatform:
        "Der Roboter hat versucht nach unten zu springen, aber unter ihm ist keine Plattform.",
    ...
    sl: {
      ...
      messages: {
        ...
        successPickedAllCollectibles:
          "Čestitamo, robot je pobral vse predmete!",
      ...
      description: {
        ...
        onTransportable:
          "naPredmetu(): Ali je robot na predmetu, ki ga lahko pobere?",
        ...
        onDottedObject:
          "naPikčastemPredmetu(): Ali je robot na pikčastem predmetu?",
        onFullObject: "naPolnemPredmetu(): Ali je robot na polnem predmetu?",
        onStripedObject:
          "naČrtastemPredmetu(): Ali je robot na črtastem predmetu?",
        paintOnCell:
          "pobarvanoPolje(): Ali je polje, na katerem je robot, pobarvano?",
        ...
        paintNorth:
          "pobarvanaZgoraj(): Ali je pobarvano polje nad poljem, na katerem je robot?",
        paintNorthWest:
          "pobarvanaZgorajLevo(): Ali je pobarvano polje levo nad poljem, na katerem je robot?",
        paintNorthEast:
          "pobarvanaZgorajDesno(): Ali je pobarvano polje desno nad poljem, na katerem je robot?",
        writeNumber:
          "zapišiŠtevilko(številka): Zapiše številko v polje, na katerem je robot."
      },
      ...
      downNoPlatform:
        "Robot se skuša premakniti dol, vendar spodaj ni ploščadi!",
...
*/
  ...
  context.customBlocks = {
    ...
    debug: {
      debug: [{ name: "alert", params: [null], handler: context.debug_alert }]
    }
  };
  ...
  context.updateScale = function() {
    ...
    paper.setSize(
      (infos.cellSide * context.nbCols + infos.leftMargin) * scale,
      (infos.cellSide * context.nbRows + infos.topMargin) * scale
    );
    for (var iRow = 0; iRow < context.nbRows; iRow++) {
      for (var iCol = 0; iCol < context.nbCols; iCol++) {
...
var robotEndConditions = {
  ...
  checkPickedAllCollectibles: function(context, lastTurn) {
    ...
    for (var iRow = 0; iRow < context.tiles.length; iRow++) {
      var row = context.tiles[iRow];
      for (var iCol = 0; iCol < row.length; iCol++) {
        var collectibles = context.getItems(iRow, iCol, {
          isCollectible: true
        });
