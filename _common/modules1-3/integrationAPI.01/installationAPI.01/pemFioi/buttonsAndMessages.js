...
         warningTimeout: "<p> Be careful, you've been on this issue for more than {0} minutes. </p> <p> You should probably change the subject, by clicking on the button at the top right. < / p> ",
         alright: "Okay",
         moveOn: "Move on",
         solvedMoveOn: "You have fully resolved this question, move on to another question.",
...
         tryNextTask: "We suggest you move on to the next topic. If you have time, come back and try the next version later.",
...
         outOf: "on",
         tryToDoBetterOrChangeTask: "Try to do even better, or go to another question.",
         tryToDoBetterOrMoveToNextLevel: "Try to do even better, or upgrade to a more difficult version.",
         bestPossibleScoreCongrats: "This is the best possible score on this subject; congratulations!",
         forMorePointsMoveToNextLevel: "To get more points, upgrade to a more difficult version.",
...
         noAnswerSaved: "No response is currently logged for this version.",
         validate: "Validate",
         restart: "Restart",
         harderLevelSolved: "Please note: you have already resolved a more difficult version. You will not be able to earn additional points with this version.",
         showLevelAnyway: "See it anyway",
         scoreObtained: "Score obtained:",
         hardVersionTakesTime: "Solving a {0} can take a long time; consider answering the questions in {1} first to earn points quickly.",
         illKeepThatInMind: "I'll take care",
         harderLevelAvailable: "Note that for this question, you can directly resolve a more difficult version than this.",
         lockedLevel: "This version is locked. Resolve the previous one to display it!",
         gradeThisAnswer: "Evaluate this answer",

         // The following messages are used for tasks with no feedback
         saveAnswer: "Save your answer",
         answerSavedModifyOrCancelIt: "Your answer has been saved. You can change it, or {0} and try again.",
         cancelIt: "cancel",
         warningDifferentAnswerSaved: "Please note: a different response is being saved.",
         youMay: "You can {0}.",
         reloadIt: "reload",
...
         contestOverScoreStays: "The contest is over, your answer is not saved and your score remains:",
         scoreWouldBecome: "With this answer, your score would be:",
         reloadValidAnswer: "Reload the validated answer.",
         contestOverAnswerNotSaved: "The contest is over: your answer is not saved.",
         scoreWouldStay: "With this answer, your score would remain the same:",
         answerNotSavedContestOver: "The contest is over, your answer has not been saved. You can {0}.",
         reloadSubmittedAnswer: "reload the response you submitted",
         difficultyWarning: "<strong> Please note: </strong> it takes time to resolve this version. <br/> You will be able to resolve 2 and 3 star versions of other subjects much faster.",
         enemyWarning: "<strong> Warning: </strong> in this challenge, the computer will prevent you from finding the solution by chance."
      },
      en: {
         version: "Version",
         levelVersionName_easy: "easy version",
