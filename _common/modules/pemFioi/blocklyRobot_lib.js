var getRobotGridContext = function(display, infos, curLevel) {
  var languageStrings = {
    fr: {
      ...
      labelLeft: "turn left",
      codeLeft: "left",
      labelForward: "move forward",
      codeForward: "move forward",
      labelEast: "move to the right",
      codeEast: "right",
      labelSouth: "move down",
      codeSouth: "low",
      labelWest: "move left",
      codeWest: "left",
      labelNorth: "move up",
      codeNorth: "high",
      labelPaint: "paint the box",
      codePaint: "paintCase",
      labelGridEdgeInFront: "edge of the grid in front",
      codeGridEdgeInFront: "frontGrilleFront",
      labelObstacleInFront: "obstacle in front",
      codeObstacleInFront: "obstacleFront",
      labelObstacleRight: "obstacle on the right",
      codeObstacleRight: "obstacleRight",
      labelObstacleLeft: "obstacle on the left",
      codeObstacleLeft: "obstacleGauche",
      labelObstacleEast: "obstacle on the right",
      codeObstacleEast: "obstacleRight",
      labelObstacleWest: "obstacle on the left",
      codeObstacleWest: "obstacleGauche",
      labelObstacleNorth: "obstacle at the top",
      codeObstacleNorth: "obstacleHaut",
      labelObstacleSouth: "obstacle below",
      codeObstacleSouth: "obstacleBas",
      labelCellGreen: "green box",
      labelCellBrown: "brown box",
      labelCellMarked: "marked box",
      codeCellGreen: "caseVerte",
      codeCellBrown: "caseMarron",
      codeCellMarked: "caseMarquee",
      labelPaintInFront: "paint in front",
      codePaintInFront: "paintingFront",
      codeColorUnder: "couleurCase",
      codeNumberUnder: "numberCase",
      labelColorUnder: "color of the box",
      labelNumberUnder: "number on the box",
      labelDir: "robot direction",
      codeDir: "direction",
      labelCol: "robot column",
      colCode: "column",
      labelRow: "robot line",
      codeRow: "line",
      labelAlert: "alert",
  ...
  var allGenerators = {
    robot: {
      paint: {
        labelEn: "paint",
        labelFr: strings.labelPaint,
        codeFr: strings.codePaint,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_paint
      },
      paintGray: {
        labelEn: "paintGray",
        labelFr: strings.labelPaintGray,
        codeFr: strings.codePaintGray,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_paintGray
      },
      forward: {
        labelEn: "forward",
        labelFr: strings.labelForward,
        codeFr: strings.codeForward,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_forward
      },
      turnAround: {
        labelEn: "turnAround",
        labelFr: "faire demi-tour",
        codeFr: "demiTour",
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_turnAround
      },
      jump: {
        labelEn: "jump",
        labelFr: "sauter",
        ...
        type: 0,
        nbParams: 0,
        fct: context.robot_jump
      },
      right: {
        labelEn: "right",
        labelFr: strings.labelRight,
        codeFr: strings.codeRight,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_right
      },
      left: {
        labelEn: "left",
        labelFr: strings.labelLeft,
        codeFr: strings.codeLeft,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_left
      },
      east: {
        labelEn: "east",
        labelFr: strings.labelEast,
        codeFr: strings.codeEast,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_east
      },
      west: {
        labelEn: "west",
        labelFr: strings.labelWest,
        codeFr: strings.codeWest,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_west
      },
      north: {
        labelEn: "north",
        labelFr: strings.labelNorth,
        codeFr: strings.codeNorth,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_north
      },
      south: {
        labelEn: "south",
        labelFr: strings.labelSouth,
        codeFr: strings.codeSouth,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_south
      },
      wait: {
        labelEn: "wait",
        labelFr: strings.labelWait,
        codeFr: strings.codeWait,
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_wait
      },
      pickTransportable: {
        labelEn: "pickTransportable",
        labelFr: "ramasser la bille",
        codeFr: "ramasserTransportable",
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_pickTransportable
      },
      dropTransportable: {
        labelEn: "dropTransportable",
        labelFr: "déposer la bille",
        codeFr: "deposerTransportable",
        category: "actions",
        type: 0,
        nbParams: 0,
        fct: context.robot_dropTransportable
      },
      onTransportable: {
        labelEn: "onTransportable",
        labelFr: "sur une bille",
        codeFr: "surTransportable",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_onTransportable
      },
      onHole: {
        labelEn: "onHole",
        labelFr: "sur un trou",
        ...
        type: 1,
        nbParams: 0,
        fct: context.robot_onHole
      },
      transportableShape: {
        labelEn: "transportableShape",
        labelFr: "forme de l'objet",
        codeFr: "formeObjet",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_transportableShape
      },
      transportableColor: {
        labelEn: "transportableColor",
        labelFr: "couleur de l'objet",
        codeFr: "couleurObjet",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_transportableColor
      },
      transportableRed: {
        labelEn: "transportableRed",
        labelFr: "l'objet est rouge",
        codeFr: "objetRouge",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_transportableRed
      },
      transportableBlue: {
        labelEn: "transportableBlue",
        labelFr: "l'objet est bleu",
        codeFr: "objetBleu",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_transportableBlue
      },
      transportableSquare: {
        labelEn: "transportableSquare",
        labelFr: "l'objet est carré",
        codeFr: "objetCarre",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_transportableSquare
      },

      greenCell: {
        labelEnd: "cellGreen",
        labelFr: "sur une case verte",
        codeFr: "caseVerte",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_greenCell
      },
      brownCell: {
        labelEnd: "cellBrown",
        labelFr: "sur une case marron",
        codeFr: "caseMarron",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_brownCell
      },
      markedCell: {
        labelEnd: "cellMarked",
        labelFr: "sur une case marquée",
        codeFr: "caseMarquee",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_markedCell
      },

      obstacleInFront: {
        labelEn: "obstacleInFront",
        labelFr: strings.labelObstacleInFront,
        codeFr: strings.codeObstacleInFront,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleInFront
      },
      obstacleRight: {
        labelEn: "obstacleRight",
        labelFr: strings.labelObstacleRight,
        codeFr: strings.codeObstacleRight,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleRight
      },
      obstacleLeft: {
        labelEn: "obstacleLeft",
        labelFr: strings.labelObstacleLeft,
        codeFr: strings.codeObstacleLeft,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleLeft
      },
      obstacleEast: {
        labelEn: "obstacleEast",
        labelFr: strings.labelObstacleEast,
        codeFr: strings.codeObstacleEast,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleEast
      },
      obstacleWest: {
        labelEn: "obstacleWest",
        labelFr: strings.labelObstacleWest,
        codeFr: strings.codeObstacleWest,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleWest
      },
      obstacleNorth: {
        labelEn: "obstacleNorth",
        labelFr: strings.labelObstacleNorth,
        codeFr: strings.codeObstacleNorth,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleNorth
      },
      obstacleSouth: {
        labelEn: "obstacleSouth",
        labelFr: strings.labelObstacleSouth,
        codeFr: strings.codeObstacleSouth,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_obstacleSouth
      },

      paintInFront: {
        labelEn: "paintInFront",
        labelFr: strings.labelPaintInFront,
        codeFr: strings.codePaintInFront,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_paintGrayInFront
      },
      colorUnder: {
        labelEn: "colorUnder",
        labelFr: strings.labelColorUnder,
        codeFr: strings.codeColorUnder,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_colorUnder
      },
      numberUnder: {
        labelEn: "numberUnder",
        labelFr: strings.labelNumberUnder,
        codeFr: strings.codeNumberUnder,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_numberUnder
      },
      gridEdgeInFront: {
        labelEn: "gridEdgeInFront",
        labelFr: strings.labelGridEdgeInFront,
        codeFr: strings.codeGridEdgeInFront,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_gridEdgeInFront
      },
      platformInFront: {
        labelEn: "platformInFront",
        labelFr: "plateforme devant",
        codeFr: "plateformeDevant",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_platformInFront
      },
      platformInFrontAndBelow: {
        labelEn: "platformInFrontAndBelow",
        labelFr: "plateforme devant plus bas",
        codeFr: "plateformeDevantPlusBas",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_platformInFrontAndBelow
      },
      platformAbove: {
        labelEn: "platformAbove",
        labelFr: "plateforme au dessus",
        codeFr: "plateformeAuDessus",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_platformAbove
      },
      dir: {
        labelEn: "dir",
        labelFr: strings.labelDir,
        codeFr: strings.codeDir,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_dir
      },
      col: {
        labelEn: "col",
        labelFr: strings.labelCol,
        codeFr: strings.codeCol,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_col
      },
      row: {
        labelEn: "row",
        labelFr: strings.labelRow,
        codeFr: strings.codeRow,
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_row
      },
      onPill: {
        labelEn: "onPill",
        labelFr: "sur une pastille",
        codeFr: "surPastille",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.robot_onPill
      }
    },
    transport: {
      number: {
        labelEn: "number",
        labelFr: "nombre total d'objets à transporter",
        codeFr: "nombreTransportables",
        category: "sensors",
        type: 1,
        nbParams: 0,
        fct: context.transportable_number
      },
      exists: {
        labelEn: "exists",
        labelFr: "il existe un objet à transporter ",
        codeFr: "existeTransportable",
        category: "sensors",
        type: 1,
        nbParams: 1,
        fct: context.transportable_exists
      },
      row: {
        labelEn: "row",
        labelFr: "ligne de l'objet à transporter",
        codeFr: "ligneTransportable",
        category: "sensors",
        type: 1,
        nbParams: 1,
        fct: context.transportable_row
      },
      col: {
        labelEn: "col",
        labelFr: "colonne d'objet à transporter",
        codeFr: "colonneTransportable",
        category: "sensors",
        type: 1,
        nbParams: 1,
        fct: context.transportable_col
      }
    },
    debug: {
      alert: {
        labelEn: "alert",
        labelFr: strings.labelAlert,
        codeFr: strings.codeAlert,
        category: "debug",
        type: 0,
        nbParams: 1,
        fct: context.debug_alert
      }
    }
  };
  ...
  var resetBoard = function() {
    for (var iRow = 0; iRow < context.nbRows; iRow++) {
      ...
      for (var iCol = 0; iCol < context.nbCols; iCol++) {
        ...
        if (itemTypeNum > 0) {
          cells[iRow][iCol] = paper.rect(
            x,
            y,
            infos.cellSide * scale,
            infos.cellSide * scale
          );
        }
      }
  ...
  var itemAttributes = function(item) {
    ...
    var y =
      (infos.cellSide * item.row - (item.side - infos.cellSide)) * scale +
      item.offsetY * scale;
    var xClip = x;
  ...
  context.updateScale = function() {
    ...
    if (context.nbCols && context.nbRows) {
      newCellSide = Math.min(
        $("#grid").width() / context.nbCols,
        $("#grid").height() / context.nbRows
      );
    } else {
      newCellSide = 0;
    }
    ...
    if (texts[0] && texts[1]) {
      texts[0].attr({
        x: infos.cellSide * 4.5 * scale,
        y: infos.cellSide * scale * 0.5,
        "font-size": 18 * scale
      });
      texts[1].attr({
        x: infos.cellSide * 7.5 * scale,
        y: infos.cellSide * scale * 0.5,
        "font-size": 18 * scale
      });
    }
