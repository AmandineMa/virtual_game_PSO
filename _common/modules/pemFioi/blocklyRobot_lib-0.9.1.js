...
            paintNorthEast: "top right paint",
...
            platformAbove: "plateAuDessus",
            gridEdgeInFront: "frontGrilleFront",
            obstacleInFront: "obstacleFront",
...
            paintInFront: "paintFront",
            paintNorthWest: "peintureHautGauche",
            paintNorth: "paintHigh",
            paintNorthEast: "paintHighRight",
            colorUnder: "couleurCase",
            numberUnder: "numberCase",
            dir: "direction",
            col: "column",
            row: "row",
            alert: "alert",
            onPill: "onPastille",
         ...
         messages: {
            marblePlacedCorrectly: "Well done, you have well placed put the ball",
            marblePlacedIncorrectly: "The marble is wrongly arranged!",
            marblesPlacedCorrectly: "Well done, you have well placed put the ball",
            marblesPlacedIncorrectly: "The marbles are misplaced!",
            reachedGreenZone: "Well done, the robot has reached the green zone",
            notReachedGreenZone: "The robot has not reached the green zone!",
            patternDrawn: "Well done, you've reproduced the pattern!",
            patternNotDrawn: "The robot did not paint the boxes exactly as desired.",

            nothingToPickUp: "Nothing to pick up",
            alreadyTransporting: "The robot is already transporting an object",
            notTransporting: "The robot tries to drop an object but does not transport it.",
            successDroppedAllObjects: "Well done, you've dropped all the items!",
            leavesGrid: "The robot is coming out of the grid!",
      ...
      de: {
         ...
         code: {
            ...
            north: "oben",
            paint: "bemale",
            pickTransportable: "hebAuf",
            dropTransportable: "legAb",
