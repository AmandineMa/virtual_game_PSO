  ...
  var languageStrings = {
    en: {
          label: {
            ...
            jump: "jump",
            down: "down",
            east: "go to the right",
            south: "go down",
            west: "go to the left",
            north: "go up",
            paint: "fix",
            pickTransportable: "pick up object",
            openLocker: "open locker",
            dropTransportable: "drop object",
    ...
    fr: {
      label: {
        ...
        hasADiamant: "un diamant est sur la case",
  ...
  context.updateScale = function () {
    ...
    if (context.nbCols && context.nbRows) {
      ...
      newCellSide = Math.min(
        400 / (context.nbCols + marginAsCols),
        600 / (context.nbRows + marginAsRows)
      );
    } else {
      newCellSide = 0;
    }
